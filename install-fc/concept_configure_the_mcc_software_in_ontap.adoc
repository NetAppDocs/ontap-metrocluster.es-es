...
Para obtener más información general sobre la configuración de ONTAP, consulte https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-ssg/home.html["Configuración de ONTAP"]
...
.En ONTAP 9.6 y posteriores
--
Ron el comando: `network interface show -service-policy default-intercluster -failover`
