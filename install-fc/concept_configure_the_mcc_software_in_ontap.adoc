...
.Paso
. Utilice los procedimientos para la conmutación negociada, la reparación y la conmutación de estado que se mencionan en el https://["Recuperación tras un desastre"].
