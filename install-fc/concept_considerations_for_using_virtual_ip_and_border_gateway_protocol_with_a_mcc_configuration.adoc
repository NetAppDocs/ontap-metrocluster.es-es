...
---
= IP virtual y BGP en una configuración de FC MetroCluster
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Revise las siguientes directrices e ilustraciones cuando planifique su solución de capa 3. Para obtener más información sobre la implantación de VIP y BGP en ONTAP, consulte link:https://docs.netapp.com/us-en/ontap/networking/configure_virtual_ip_@vip@_lifs.html["Configure los LIF de IP virtuales"^].
...
Una vez configurada, la existencia de v0a (v0b y demás) valida continuamente la conectividad, garantizando que una migración LIF o una recuperación tras fallos se realice correctamente (a diferencia de L2, donde una configuración rota sólo es visible después de la interrupción).
