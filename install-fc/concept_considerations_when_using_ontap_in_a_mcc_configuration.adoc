...
NOTE: Antes de configurar el agregado, debe configurar almacenes de objetos como se describe en "Configuración de almacenes de objetos para FabricPool en una configuración de MetroCluster" en lahttps://["Gestión de discos y agregados"]
...
A partir de ONTAP 9.11.1, https://["grupos de consistencia"^] Son compatibles con las configuraciones de MetroCluster.
