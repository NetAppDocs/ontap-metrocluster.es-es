...
---
= Aspectos a tener en cuenta en ONTAP para configuraciones de MetroCluster
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/svm_dr_image_2.gif[Recuperación ante desastres de SVM después de la conmutación]
...
Consulta la sección «`Replicating the SVM configuration`» en la link:http://docs.netapp.com/ontap-9/topic/com.netapp.doc.pow-dap/home.html["Protección de datos con la interfaz de línea de comandos"^] para ver detalles sobre cómo configurar una relación de SVM DR.
