...
5+| Configuraciones que utilizan puentes FibreBridge 6500N o FibreBridge 7500N o 7600N utilizando sólo un puerto FC (FC1 o FC2) 
...
8+| Configuraciones que utilizan puentes FibreBridge 6500N o FibreBridge 7500N o 7600N utilizando sólo un puerto FC (FC1 o FC2) 
...
21
 ...
 a| 
Los puertos 12 a 15 de &ast están reservados para el segundo grupo MetroCluster o DR del switch Brocade 7840.
...
| FibreBridge 7500 con dos puertos FC | Puerto | Interruptor 1 | Interruptor 2 
...
| FibreBridge 7500 con dos puertos FC | Puerto | Conmutador | Interruptor 2 
...
|===
Se pueden conectar puentes adicionales para un segundo grupo DR o una segunda configuración MetroCluster utilizando los mismos números de puerto del segundo módulo MDS.
...
Las tablas siguientes muestran el uso de puertos de puente cuando se utilizan puentes FibreBridge 6500 o puentes FibreBridge 7500 sólo con un puerto FC (FC1 o FC2). En el caso de los puentes FibreBridge 7500 que utilicen un puerto FC, puede cablearse FC1 o FC2 al puerto indicado como FC1. Se pueden conectar puentes adicionales utilizando los puertos 25-48.

|===


4+| Puentes FiberBridge 6500 o puentes FibreBridge 7500 con un puerto FC 


.2+| Puente FibreBridge 6500 o FibreBridge 7500 con un puerto FC .2+| Puerto 2+| Cisco 9396S 
...
| Puente FibreBridge 6500 o FibreBridge 7500 con un puerto FC | Puerto | Interruptor 1 | Interruptor 2 
