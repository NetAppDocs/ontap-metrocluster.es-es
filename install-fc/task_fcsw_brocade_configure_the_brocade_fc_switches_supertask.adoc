...
---
= Configura manualmente los switches FC de Brocade en una configuración FC de MetroCluster
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Los siguientes switches FC de Brocade son compatibles con el cifrado WAN ISL y la compresión para las estructuras de back-end de MetroCluster FC:
+
** Brocade G720
** Brocade G630
** Brocade G620
...
== Revisar los requisitos de la licencia de Brocade
...
== Establezca los valores del interruptor Brocade FC a los valores predeterminados de fábrica
...
== Configurar los ajustes básicos del conmutador
...
+
https://docs.netapp.com/us-en/ontap-metrocluster/install-fc/concept_configure_the_mcc_software_in_ontap.html#configuring-in-order-delivery-or-out-of-order-delivery-of-frames-on-ontap-software["Configurar la entrega en orden o fuera de orden de fotogramas en el software ONTAP"]





. Si está ejecutando una versión anterior a FOS 9.0, verifique que el conmutador esté usando el método de licencia dinámico Port on Demand (POD).
+
...
== Configurar los ajustes básicos del conmutador en un conmutador Brocade DCX 8510-8
...
== Configurar puertos E en conmutadores FC de Brocade mediante puertos FC
...
== Configurar puertos VE de 40 Gbps en los conmutadores FC Brocade 7810 y 7840
...
== Configurar los puertos no E en el conmutador Brocade
...
== Configurar la compresión en los puertos ISL en un conmutador Brocade G620
...
== Configurar la zonificación en los conmutadores Brocade FC
...
=== Puentes de zona FibreBridge 7500N o 7600N que utilizan un puerto FC
...
|===
| Switch FC | Sitio | Dominio del switch | Puerto de conmutador Brocade 6505, 6510, 6520, G620, G610 o G710 | Conecta a... 
...
|===
| Switch FC | Sitio | Dominio del switch | Conmutador Brocade 6505, 6510, 6520, G620, G610 o G710 | Conecta a... 
...
=== Puentes Zone FibreBridge 7500N que utilizan ambos puertos FC
...
| Switch FC | Sitio | Dominio del switch | Puerto 6505/6510/G610/G710/G620 | 6520 puertos | Conecta a... 
...
| Switch FC | Sitio | Dominio del switch | Puerto 6505/6510/G610/G710 | 6520 puertos | Puerto G620 | Conecta a... 
...
| Switch FC | Sitio | Dominio del switch | 6505 / 6510 / G610 / G710 | 6520 | G620 | Conecta a... 
...
=== Ubica los conmutadores Brocade FC
...
== Configurar el cifrado ISL en los conmutadores Brocade 6510 o G620
