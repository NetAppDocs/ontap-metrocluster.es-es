...
---
= Configura manualmente los switches Cisco en una configuración FC de MetroCluster
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Información relacionada
Debe verificar que esté utilizando las asignaciones de puertos especificadas al cablear los conmutadores FC. Consulte link:concept_port_assignments_for_fc_switches_when_using_ontap_9_1_and_later.html["Asignaciones de puertos para conmutadores FC"]
...
image::../media/fcip_ports_dual_isl.gif[Diagrama que muestra los puertos FCIP con configuración ISL dual en cada conmutador]
...
Los siguientes pasos utilizan la zonificación descrita en la sección Zonificación para un FibreBridge 7500N en una configuración MetroCluster de cuatro nodos.
