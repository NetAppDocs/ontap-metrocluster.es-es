...
---
= Instala puentes FC a SAS y bandejas de discos SAS en una configuración FC de MetroCluster
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/workflow_bridge_installation_and_configuration.gif[Flujo de trabajo de instalación y configuración del puente FC a SAS]
