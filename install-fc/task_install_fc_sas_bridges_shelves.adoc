...
* <<cabling_fb_6500N_with_iom6_iom3,Cableado de un puente FibreBridge 6500N con bandejas de discos mediante módulos IOM6 o IOM3>>
...
----
+ NOTA: Si el texto "esponse truncada" aparece al principio de la salida, puede utilizar Telnet para conectarse al puente e introducir el mismo comando para ver toda la salida.
...
Debe verificar que está utilizando las asignaciones de puertos especificadas al cablear los switches FC. Las asignaciones de puertos son diferentes entre ONTAP 9.0 y la versión posterior de ONTAP.
