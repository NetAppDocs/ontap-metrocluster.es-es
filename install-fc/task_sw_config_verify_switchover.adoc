...
image::../media/workflow_high_level_node_and_cluster_configuration_software.gif[Configuración de nodos y clústeres de alto nivel del flujo de trabajo en ONTAP]
...
* Los nombres de agregados deben ajustarse al esquema de nomenclatura que se determinó al planificar la configuración de MetroCluster. Consulte https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-psmg/home.html["Gestión de discos y agregados"^].
...
.Información relacionada
link:https://docs.netapp.com/us-en/ontap/high-availability/index.html["Gestión de parejas de HA"^]
...
.Paso
. Utilice los procedimientos para la conmutación negociada, la reparación y la conmutación de regreso https://docs.netapp.com/us-en/ontap-metrocluster/manage/index.html["Gestión y recuperación ante desastres de MetroCluster"]
...
+
https://docs.netapp.com/us-en/ontap/system-admin/config-backup-file-concept.html["Gestión de backups de configuración"^] contiene información adicional.



.Información relacionada
https://docs.netapp.com/us-en/ontap/cluster-admin/index.html["Administración de clústeres"^]
