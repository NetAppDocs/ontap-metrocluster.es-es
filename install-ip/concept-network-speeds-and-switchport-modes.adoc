...
* Los sistemas AFF A30, AFF C30, AFF C60 y FAS50 requieren un adaptador QSFP-to-SFP en la tarjeta del controlador para admitir una velocidad de red de 25Gbps.
