...
link:../manage/concept_understanding_mcc_data_protection_and_disaster_recovery.html#mediator-assisted-automatic-unplanned-switchover-in-metrocluster-ip-configurations["Obtenga más información sobre un MAUSO en las configuraciones IP de MetroCluster"].
