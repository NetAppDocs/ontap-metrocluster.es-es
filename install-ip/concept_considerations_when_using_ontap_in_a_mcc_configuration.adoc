...
Para obtener información general sobre el uso de FabricPool, consulte https://["Gestión de discos y niveles (agregados)"^].
...
NOTE: Antes de configurar el agregado, debe configurar almacenes de objetos como se describe en "Configuración de almacenes de objetos para FabricPool en una configuración de MetroCluster" en https://["Gestión de discos y agregados"^].
...
. Cree el reflejo de FabricPool con el agregado, tal como se describe en https://["Gestión de discos y agregados"^]
+
...
Consulte «"replicar la configuración de SVM" en http://["Protección de datos"^] Para obtener detalles sobre la configuración de una relación de recuperación ante desastres de SVM.
