...
---
= Configurar SNMPv3 para supervisar el estado de los conmutadores IP de MetroCluster
:allow-uri-read: 
...
Este procedimiento muestra los pasos genéricos para configurar SNMPv3 en un conmutador. Es posible que algunas de las versiones de firmware del conmutador mencionadas no sean compatibles con una configuración IP de MetroCluster.

Debe seguir los pasos para una versión de firmware del conmutador compatible con una configuración IP de MetroCluster. Consulte la link:https://hwu.netapp.com["Hardware Universe"^] para verificar las versiones de firmware compatibles.
...
.Switches Cisco
--
Configura un nombre de usuario SNMPv3 SNMPv3_USER en los switches Cisco Nexus:
...
.NVIDIA - CL 5.4.0
--
Configura un nombre de usuario SNMPv3 SNMPv3_USER en los switches NVIDIA Cumulus que ejecutan CL 5.4.0:
...
.NVIDIA - CL 5.11.0+
--
Configura un nombre de usuario SNMPv3 SNMPv3_USER en los switches NVIDIA Cumulus que ejecutan CLI 5.11.0 o versiones posteriores:
