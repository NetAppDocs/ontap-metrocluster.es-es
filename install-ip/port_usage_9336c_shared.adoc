...
* Cuando conectas un switch Cisco 9336C-FX2 a almacenamiento NS224, solo puedes tener un máximo de dos configuraciones MetroCluster o grupos DR. Al menos una configuración MetroCluster o grupo DR debe conectar estanterías NS224 al switch MetroCluster. Si una de tus configuraciones MetroCluster o grupos DR es un sistema que no admite estanterías NS224, solo se puede conectar como la segunda configuración MetroCluster o grupo DR.
+
