...
El control del estado de los switches de Ethernet (CSHM) es responsable de garantizar el estado operativo de los switches de red y de recopilar los registros de los switches con fines de depuración. Este procedimiento te guía por el proceso de configurar la recopilación, solicitar registros detallados de *Support* y habilitar una recopilación por hora de datos *Periodic* que recopila AutoSupport.
