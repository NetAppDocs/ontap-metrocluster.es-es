...
---
= Administrar el mediador de ONTAP con System Manager en las configuraciones de IP de MetroCluster
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Sólo puedes configurar un ONTAP Mediator que use HTTPS mediante la CLI. System Manager no es compatible. Para más información, consulta link:concept_mediator_requirements.html#select-a-communication-protocol-for-ontap-mediator["Selecciona un protocolo de comunicación para ONTAP Mediator"].
