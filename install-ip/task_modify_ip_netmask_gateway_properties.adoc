...
[role="lead"]
A partir de ONTAP 9.10.1, puede cambiar las siguientes propiedades de una interfaz IP de MetroCluster: Dirección IP y máscara y puerta de enlace. Puede usar cualquier combinación de parámetros para actualizar.
