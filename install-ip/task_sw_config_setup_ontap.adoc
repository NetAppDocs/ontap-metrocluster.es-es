...
+
Puede usar System Manager de ONTAP para dirigir el navegador web a la dirección IP de administración del clúster (https://172.17.12.153)[].

+
https://docs.netapp.com/ontap-9/topic/com.netapp.doc.onc-sm-help/GUID-DF04A607-30B0-4B98-99C8-CB065C64E670.html["Gestión de clústeres mediante System Manager (versiones de 9.0 a 9.6)"]
