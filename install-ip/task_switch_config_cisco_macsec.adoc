...
summary: Si es necesario, configura el cifrado MACsec solo en los puertos ISL de la WAN que van entre los sitios. Si eliges usar el cifrado MACsec, configúralo después de aplicar el archivo RCF correcto. 
---
= Configura el cifrado MACsec en los switches Cisco 9336C en un sitio IP MetroCluster (opcional)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Si es necesario, puedes configurar el cifrado MACsec en los puertos ISL de la WAN que van entre los sitios. Si decides usar el cifrado MACsec, debes configurarlo después de aplicar el archivo RCF correcto.

[NOTE]
====
* La encriptación MACsec solo puede aplicarse a los puertos WAN ISL que van entre los sitios.
* Configurar el cifrado MACsec es opcional al configurar los switches Cisco 9336C.
