...
---
= Tablas de puertos para configuraciones IP de MetroCluster
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Debes saber cómo utilizar la información de las tablas de puertos para generar correctamente tus archivos de configuración de referencia (RCFs).
