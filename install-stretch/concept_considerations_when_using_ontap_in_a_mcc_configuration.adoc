...
Consulte la sección «"replicar la configuración de SVM" en la https://["Protección de datos con la interfaz de línea de comandos"^] Para obtener detalles sobre la configuración de una relación de recuperación ante desastres de SVM.
