...
image::../media/mcc_hardware_architecture_both_clusters_2_node_atto.gif[Arquitectura de hardware MetroCluster de dos nodos, ambos clústeres con puentes FC a SAS]
