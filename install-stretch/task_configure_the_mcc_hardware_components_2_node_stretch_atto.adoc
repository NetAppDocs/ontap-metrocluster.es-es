...
image::../media/workflow_hardware_installation_and_configuration_2_node_bridge_attached.gif[Configuración del hardware del flujo de trabajo: configuración de un puente de dos nodos adjunto]
