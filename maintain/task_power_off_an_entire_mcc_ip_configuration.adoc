...
---
= Apague toda una configuración de IP de MetroCluster
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga toda la configuración de MetroCluster IP y todo el equipo antes de empezar el mantenimiento o la reubicación.
...
. Verifica la configuración de MetroCluster desde ambos sitios.
+
...
NOTE: En una configuración IP de MetroCluster, el dominio de fallo de AUSO ya está establecido en 'auso-disabled' a menos que la configuración use ONTAP Mediator.
	...
	cluster_A_site_A::*> metrocluster operation show
      ...
      Start Time: 4/25/2020 20:20:36
        End Time: 4/25/2020 20:20:36
          Errors: -
----
. Detén los nodos en ambos sitios:
+
[listing]
----
