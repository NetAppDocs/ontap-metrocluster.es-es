...
.. Configure el nuevo conmutador siguiendo los procedimientos de Brocade en link:../install-fc/concept-configure-fc-switches.html["Configure los switches FC"].
+
...
. Para habilitar el cifrado ISL, consulte link:../install-fc/task_fcsw_brocade_configure_the_brocade_fc_switches_supertask.html#setting-isl-encryption-on-brocade-6510-or-g620-switches["Configurar manualmente los switches FC de Brocade"].
+
