...
+
image::../media/mcc_shelf_replacement_bridges_with_a_single_stack.gif[Puentes de sustitución de estanterías con una sola pila]
...
+
image::../media/mcc_shelf_replacement_bridges_with_four_stacks.gif[Puentes de sustitución de estanterías con cuatro pilas]
