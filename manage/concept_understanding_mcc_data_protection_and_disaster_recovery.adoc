...
+
En una configuración MetroCluster de cuatro nodos, este error podría provocar una toma de control automática o negociada del nodo dañado, según el componente que haya fallado. La recuperación de datos se describe en _High Availability Configuration Guide_.
...
+
La _Guía de configuración de alta disponibilidad_ contiene más información acerca de cómo recuperarse de errores de controlador en todo el sitio que no incluyen fallos de controlador, así como errores que incluyen uno o más controladores.
...
http://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-hacg/home.html["Configuración de alta disponibilidad"^]
