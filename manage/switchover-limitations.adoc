...
[role="lead"]
Cuando el sistema está en conmutación de sitios, NetApp recomienda que evites realizar ciertas operaciones.

Las siguientes operaciones no se recomiendan cuando el sistema está en conmutación de sitios y solo debes realizarlas bajo la guía del soporte de NetApp:

* Crear o eliminar agregados
* Creación o eliminación de volúmenes (incluidos los volúmenes cifrados)
