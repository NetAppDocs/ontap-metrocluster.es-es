...
summary:  
---
= Novedades de la plataforma IP de MetroCluster y soporte de switches
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conozca las novedades en la plataforma IP y el soporte de conmutadores de MetroCluster.
...
| Switches NVIDIA | Comienzo disponible 
 ...
 a| 
Múltiples configuraciones de MetroCluster IP en el mismo switch NVIDIA SN2100
 a| 
ONTAP 9.14.1
