...
Transición de FC de MetroCluster a IP de MetroCluster mediante un switch compartido para el almacenamiento conectado a Ethernet y MetroCluster IP
 a| 
Puede realizar la transición de forma no disruptiva de una configuración MetroCluster FC a una configuración de IP de MetroCluster (ONTAP 9,8 y versiones posteriores) mediante un switch compartido.
...
ONTAP 9,6
 ...
 a| 
Actualice el clúster con el administrador del sistema de ONTAP
 a| 
Un clúster se puede actualizar en configuraciones de MetroCluster. Para los clústeres en configuraciones de MetroCluster, debe realizar cada operación en ambos clústeres, excepto en la actualización del clúster.

https://docs.netapp.com/us-en/ontap-sm-classic/online-help-96-97/index.html["Gestión de clústeres mediante System Manager"]
 a| 
ONTAP 9,5
