...
Consulte la link:whats_new.html#os-support-matrix["Matriz de soporte de SO"] para obtener más detalles.
 a| 
Ninguno. OpenJDK 19.0.2 se incluye en la instalación.
...
.El futuro
* Si estás instalando o actualizando a Tiebreaker 1.5 o posterior, link:install_security.html["Proteja la instalación del host y de la base de datos de tiebreaker"].
* Si estás instalando o actualizando a Tiebreaker 1.4, link:install-dependencies-14.html["Instale las dependencias de MetroCluster tiebreaker 1,4"].
