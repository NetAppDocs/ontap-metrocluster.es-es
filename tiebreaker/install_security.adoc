...
+
** Se admite el cifrado de datos en reposo. link:https://mariadb.com/docs/server/security/encryption/data-at-rest-encryption/data-at-rest-encryption-tde-fundamentals["Más información sobre el cifrado de datos en reposo"^]
...
.El futuro
link:install-choose-procedure.html["Elija su procedimiento de instalación"] para instalar o actualizar Tiebreaker.
