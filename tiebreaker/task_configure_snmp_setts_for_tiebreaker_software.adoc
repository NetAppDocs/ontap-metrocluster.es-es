...
---
= Configura los ajustes SNMP para el software MetroCluster Tiebreaker
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.El futuro
link:concept_monitoring_the_mcc_configuration.html["Supervise la configuración de MetroCluster"]
