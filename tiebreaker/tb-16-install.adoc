...
summary: Realice una nueva instalación o actualización a tiebreaker 1,6 en el sistema operativo Linux del host para supervisar las configuraciones de MetroCluster. 
---
= Instalar Tiebreaker 1.6 o 1.6P1
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Realice una nueva instalación o actualización a tiebreaker 1,6 o tiebreaker 1.6P1 en el sistema operativo Linux del host para supervisar las configuraciones de MetroCluster.

.Acerca de esta tarea
* Su sistema de almacenamiento debe ejecutar ONTAP 9.12.1 o una versión posterior.
...
NOTE: Después de instalar Tiebreaker 1.6 o posterior, necesitas link:concept_configuring_the_tiebreaker_software.html#import-certificates-tb17["importar certificados"] para habilitar la supervisión continua.



== Instale o actualice a tiebreaker 1.6P1

Puede instalar tiebreaker 1.6P1 o actualizar a tiebreaker 1.6P1 desde tiebreaker 1,6, 1,5 o 1,4.

.Pasos
. Descargue el software MetroCluster tiebreaker 1.6P1.
+
...
. Si está realizando una actualización, compruebe la versión de tiebreaker que está ejecutando:
+
En el siguiente ejemplo, se muestra tiebreaker 1,5.
...
[role="tabbed-block"]
====
.Instale tiebreaker 1.6P1
--
Siga estos pasos para una nueva instalación de tiebreaker 1.6P1.

.Pasos
.. Ejecute el siguiente comando en la `[root@mcctb ~] #` solicitar que comience la instalación:
+
[source, cli]
----
...
--
.Actualización 1,6 a 1.6P1
--
Siga estos pasos para actualizar la versión de software de tiebreaker 1,6 a tiebreaker 1.6P1.


NOTE: Después de actualizar a tiebreaker 1.6P1 de 1,6, elimina los monitores existentes y vuelve a añadir la configuración de MetroCluster para la supervisión.

.Pasos
.. Ejecute el siguiente comando en la `[root@mcctb ~] #` solicitar actualización del software:
+
[source, cli]
----
sh MetroClusterTiebreakerInstall-1.6P1
...
----
=====
.. Elimine y vuelva a añadir la configuración de MetroCluster siguiendo los pasos de link:concept_configuring_the_tiebreaker_software.html["Configure el software Tiebreaker"].


--
.Actualización 1,5 a 1.6P1
--
Siga estos pasos para actualizar la versión de software de tiebreaker 1,5 a tiebreaker 1.6P1.
...
--
.Actualización 1,4 a 1.6P1
--
Siga estos pasos para actualizar la versión de software de tiebreaker 1,4 a tiebreaker 1.6P1.
...
== Instale o actualice a tiebreaker 1,6

Puede instalar tiebreaker 1,6 o actualizar a tiebreaker 1,6 desde tiebreaker 1,5 o 1,4.

.Pasos
. Descargue el software MetroCluster tiebreaker 1,6.
+
https://mysupport.netapp.com/site/products/all/details/metrocluster-tiebreaker/downloads-tab["MetroCluster tiebreaker (descargas) - Sitio de soporte de NetApp"^]
...
[role="tabbed-block"]
====
.Instale tiebreaker 1,6
--
Utilice los siguientes pasos para una nueva instalación de tiebreaker 1,6.
...
--
.Actualizar 1,5 a 1,6
--
Utilice los siguientes pasos para actualizar la versión de software de tiebreaker 1,5 a tiebreaker 1,6.
...
--
.Actualizar 1,4 a 1,6
--
Utilice los siguientes pasos para actualizar la versión de software de tiebreaker 1,4 a tiebreaker 1,6.
...
.El futuro
Una vez que hayas instalado o actualizado correctamente Tiebreaker, link:configure-tb-workflow.html["configura el software MetroCluster Tiebreaker"] para añadir las configuraciones de MetroCluster e importar los certificados necesarios.
