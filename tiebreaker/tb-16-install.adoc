...
[role="lead"]
Realice una nueva instalación o actualización a tiebreaker 1,6 en el sistema operativo Linux del host para supervisar las configuraciones de MetroCluster.
...
--
.Actualice de tiebreaker 1,5 a 1,6
--
...
--
.Actualice de tiebreaker 1,4 a 1,6
--
