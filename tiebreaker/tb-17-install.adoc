...
---
= Instalar MetroCluster Tiebreaker 1.7
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instale o actualice a Tiebreaker 1.7 en su host Linux para monitorear las configuraciones de MetroCluster .

.Acerca de esta tarea
* Su sistema de almacenamiento debe ejecutar ONTAP 9.12.1 o una versión posterior.
* Solo puedes actualizar a Tiebreaker 1.7 desde Tiebreaker 1.6P1. Referirse alink:tb-16-install.html["Instalar Tiebreaker 1.6 o 1.6P1"] .
...
NOTE: Después de instalar Tiebreaker 1.7, necesitas link:concept_configuring_the_tiebreaker_software.html#import-certificates-tb17["importar certificados"] para habilitar la supervisión continua.

.Pasos
. Descargue el software MetroCluster Tiebreaker 1.7.
+
...
. Si está actualizando, verifique qué versión de Tiebreaker está ejecutando:
+
El siguiente ejemplo muestra el desempate 1.6P1
...
[role="tabbed-block"]
====
.Instalar Tiebreaker 1.7
--
Utilice los siguientes pasos para una nueva instalación de Tiebreaker 1.7.
...
--
.Actualizar 1.6P1 a 1.7
--
Utilice los siguientes pasos para actualizar la versión del software Tiebreaker 1.6P1 a Tiebreaker 1.7.
...
NOTE: Si su actualización falla con un error debido a certificados faltantes, consultelink:../tiebreaker/concept_configuring_the_tiebreaker_software.html#import-certificates-tb17["Certificados de importación"] .  Después de importar sus certificados, puede intentar actualizar nuevamente.
