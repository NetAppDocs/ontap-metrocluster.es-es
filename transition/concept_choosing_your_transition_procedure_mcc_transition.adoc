...
No disruptivas
 a| 
Se requieren nuevas estanterías de almacenamiento en las nuevas plataformas.  Una vez finalizada la transición, se retiran del clúster los controladores, estantes y discos antiguos.
 a| 
...
*Nota:* Este procedimiento admite las siguientes transiciones de FC a IP:

* De una configuración MetroCluster FC de cuatro nodos a una configuración MetroCluster IP de cuatro nodos
* De una configuración MetroCluster FC de ocho nodos a una configuración MetroCluster IP de ocho nodos
