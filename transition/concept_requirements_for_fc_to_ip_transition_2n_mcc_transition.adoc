...
+
image::../media/transition_2n_4_new_ip_nodes_on_the_shelves.png[Transición con cuatro nuevos nodos IP en los estantes existentes]
...
image::../media/workflow_2n_transition_bsaic.png[Flujo de trabajo para la transición de dos nodos]
...
+
link:../tiebreaker/concept_configuring_the_tiebreaker_software.html#remove-metrocluster-configurations["Eliminación de las configuraciones de MetroCluster"]
