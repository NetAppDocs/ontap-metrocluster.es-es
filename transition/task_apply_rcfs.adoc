...
NOTE: Si estás llevando a cabo una transición de FC de cuatro nodos a IP de ocho nodos, puedes aplicar la RCF de FC de cuatro nodos a IP de ocho nodos antes de añadir el segundo grupo de DR. No tienes que aplicar primero la RCF de FC de cuatro nodos a IP de cuatro nodos.
