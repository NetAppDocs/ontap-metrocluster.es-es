...
. Si está utilizando el Administrador de claves integrado, realice los siguientes pasos desde el clúster donde agregó un nuevo nodo:
+
.. Sincronizar la configuración del administrador de claves:
+
`security key-manager onboard sync`

.. Introduzca la contraseña del administrador de claves a bordo cuando se le solicite.
