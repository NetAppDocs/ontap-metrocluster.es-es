...
image::../media/transition_2n_4_new_ip_nodes_and_shelves.png[Cableado de nuevos nodos IP y estantes para la transición]
...
image::../media/transition_2n_booting_a_2_and_b_2.png[Arranque de nuevos nodos IP durante la transición]
