...
*Nota:* Los puertos de conmutación 13 y 14 solo se pueden usar cuando se seleccionan dos modos de velocidad.
 a| 
La interfaz del clúster local en el nodo FC
 ...
 a| 
Cisco 9336C-FX2 compartido
 a| 
Cualquiera
 a| 
3, 4 o 11, 12

*Nota:* Los puertos de conmutación 11 y 12 solo se pueden usar cuando se seleccionan dos modos de velocidad.
 a| 
La interfaz del clúster local en el nodo FC
