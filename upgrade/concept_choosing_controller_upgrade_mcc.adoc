...
image:../media/mccip_manual_controller_upgrade_comb.png["Muestra las plataformas AFF y FAS admitidas para actualizar manualmente las controladoras mediante la conmutación de sitios y la conmutación de estado"]
