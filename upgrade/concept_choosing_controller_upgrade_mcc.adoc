...
image::../media/metrocluster_ip_upgrade_table_yellowdogdp1.PNG[tabla de actualización ip de MetroCluster yellowdodp1]
...
image::../media/metrocluster_fc_upgrade_table_yellowdogp1.PNG[tabla de actualización MetroCluster fc yellowdop1]
