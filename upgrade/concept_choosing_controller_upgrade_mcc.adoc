...
NOTE: Para obtener información sobre actualizaciones compatibles utilizando `system controller replace` comandos en una configuración de IP de MetroCluster de cuatro nodos, consulte la tabla de link:task_upgrade_controllers_system_control_commands_in_a_four_node_mcc_ip.html["Actualizar controladoras en una configuración IP de MetroCluster de cuatro nodos mediante conmutación de sitios y conmutación de estado con comandos de sustitución de controladoras del sistema (ONTAP 9.13.1 y versiones posteriores)"]
...
NOTE: Los sistemas AFF A90, AFF A70 y AFF A1K requieren ONTAP 9.15.1 o posterior.
