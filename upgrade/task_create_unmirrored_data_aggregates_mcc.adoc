...
+
Compruebe que solo va a incluir unidades de la bandeja no reflejada en el agregado.
...
NOTE: También puede usar `-disklist` el parámetro del comando para especificar los discos que desea usar para el agregado.
