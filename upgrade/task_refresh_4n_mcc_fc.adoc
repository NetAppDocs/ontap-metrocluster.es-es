...
. Mueva los datos de los nodos antiguos a los nuevos nodos con los siguientes procedimientos a. https://["Otros procedimientos de la plataforma: Actualización Express del hardware de la controladora"^].
+
...
.. Realice todos los pasos de http://["Eliminación de LIF SAN de los nodos originales"].
