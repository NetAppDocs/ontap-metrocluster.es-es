...
* Durante el procedimiento de actualización, no debe añadir ni quitar otras tarjetas del sistema A700 o FAS9000 de AFF. Para obtener más información, consulte https://["Hardware Universe de NetApp"^]
...
. Desde la https://["Página de descarga de archivos RCF de MetroCluster"^], Descargue el archivo RCF correcto para un MetroCluster de estructura AFF A900 o FAS9500 y el modelo de switch que se utiliza en la configuración AFF A700 o FAS9000.
...
. Si se le solicita que continúe el procedimiento, introduzca `y`, Y cuando se le solicite el paquete, escriba la dirección URL:http://[]
