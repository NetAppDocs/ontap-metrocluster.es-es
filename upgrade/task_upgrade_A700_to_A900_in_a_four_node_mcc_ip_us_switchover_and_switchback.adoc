...
. Si los nodos de MetroCluster utilizan el cifrado de volúmenes o agregados, copie información sobre las claves y las Passphrases. Para obtener más información, consulte https://["Realizar un backup manual de la información de gestión de claves incorporada"^].
+
