...
e3a, e3b
 a| 
No hay puerto que coincida. Después de la actualización, vuelva a crear los puertos del clúster. link:task_prepare_cluster_ports_on_the_exist_controller.html["Preparar puertos del clúster en un módulo de controladora existente"]
