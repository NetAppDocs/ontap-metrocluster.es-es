...
* Puedes usar este procedimiento para actualizar los controladores en una configuración FC de cuatro nodos MetroCluster usando la conmutación de sitios y reversión automatizadas basadas en NSO. Si quieres realizar una actualización de controladores usando la reubicación de agregados (ARL), consulta link:https://docs.netapp.com/us-en/ontap-systems-upgrade/upgrade-arl-auto-app/["Utilice comandos para sustituir la controladora del sistema para actualizar el hardware de la controladora que ejecute ONTAP 9.8 o una versión posterior"^]. Se recomienda usar el procedimiento automatizado basado en NSO.
