...
NOTE: Cuando ejecutas la opción del menú de arranque `6`, es posible que los valores de bootarg de MetroCluster tengan que restablecerse. Consulta link:upgrade-mcc-ip-manual-apply-rcf-set-bootarg.html#set-the-metrocluster-ip-bootarg-variables["Establezca las variables bootarg de MetroCluster IP"].
