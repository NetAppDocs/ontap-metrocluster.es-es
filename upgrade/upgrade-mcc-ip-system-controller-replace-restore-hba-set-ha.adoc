...
.El futuro
link:upgrade-mcc-ip-system-controller-replace-apply-rcf-set-bootarg.html["Actualice los archivos RCF del switch y defina los valores de inicio de IP de MetroCluster"].
